...
\begin{definition}[partieller Differentialoperator]
Ein Gebiet $\Omega$ ist eine offene Teilmenge von $\mathbb{R}^n$.
Ein {\em partieller Differentialoperator} der Ordnung $r$ ist eine
Linearkombination
\index{Differentialoperator!partiell}%
\index{partieller Differentialoperator}%
\[
L
=
...
Für den Laplace-Operator lassen sich die folgenden Gleichungen
formulieren:
\begin{align*}
