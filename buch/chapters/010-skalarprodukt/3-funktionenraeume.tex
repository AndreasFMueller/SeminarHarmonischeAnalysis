...
\input{chapters/010-skalarprodukt/fig/fourierrechteck.tex}
...
\end{equation}
\index{L2-Skalarprodukt@$L^2$-Skalarprodukt}%
\index{Skalarprodukt!stetige Funktionen}%
\end{definition}
...
\begin{definition}[stetige Funktionen mit kompaktem Träger $C_0(X)$]
...
%
% Unzulänglichkeiten des Riemann-Integrals
%
\subsection{Unzulänglichkeiten des Riemann-Integrals
...
\begin{definition}[integrierbare Funktionen $\mathscr{L}^1$, quadratintegierbare Funktionen $\mathscr{L}^2$]
...
\]
bezeichnet.
\index{L1@$\mathscr{L}^1$}
\index{L2@$\mathscr{L}^2$}
\index{integrierbare Funktion}%
\index{quadratintegrierbare Funktion}%
\index{Funktion!integrierbar}%
\index{Funktion!quadratintegierbar}%
...
\begin{definition}[Gleichheit fast überall]
Die Relation
\[
f\sim g
