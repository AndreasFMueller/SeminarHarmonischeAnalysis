...
\index{Matrix des Skalarproduktes}%
\index{Skalarprodukt!Matrix}%
...
\index{hyperbolisches Skalarprodukt}%
...
\begin{definition}[konjugiert linear]
...
\begin{definition}[konjugiert symmetrisch, hermitesch]
\index{buch:skalarprodukt:definition:def:hermitesch}
...
\begin{definition}[komplex konjugierte Matrix]
