...
Ein grosses Problem im Zusammenhang mit Rauschen, ist die Differenzierbarkeit. Dies ist häufig beim Umgang mit Mess-Signalen der Fall, was das bestimmen einer lokalen Steigung erschwert und die Äderungsrate verfälschen kann. Davon sind auch empfangene Datensignale betroffen, was zu falsch dekodierten Informationen führen kann. Die einfachste Methode und häufig auch ein erster Schritt, ist die Anwendung eines Tiefpass- oder Bandpass-Filters. Dieser entfernt jedoch nicht nur das Rauschen, sondern auch ein Teil der im Signal enthaltenen Information.
