...
$ b $ ist der Drift-Vektor und beschreibt die erwartete Veränderung für jeden inneren Zustand / jede Dimension des Systems. $ B $ ist die Dispersionsmatrix und beschreibt wie sich das $m$-dimensionale Rauschen auf das $n$-dimensionale System auswirkt. Dabei beschreibt die Diagonale der Matrix wie stark sich das Rauschen auf jede Dimension auswirkt und die Dreieckberreiche der Matrix beschreiben die Beeinflussung der Dimensionen untereinander. Alles in allem beschreiben $ b $ und $ B $ die Dynamik des Systems. 
