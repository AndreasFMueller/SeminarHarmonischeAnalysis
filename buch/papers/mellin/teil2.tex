...
% Satz: Eine (kommutative?) Integraltransformation enthält das Faltungstheorem!
% Dafür braucht es Funktionen, welche die Gruppenoperation in eine \textbf{Multiplikation} überführt. Dies gilt sowohl für die Gruppenoperationen 
% der Gruppe im Ortsraum als auch für die Gruppenoperation der dualen Gruppe im Bildraum der Transformation.
% \begin{equation}
%     f(x \diamond y) = f(x) \cdot f(y)
% \end{equation}
% Wobei $\diamond$ der Gruppenoperation enstpricht.
...
% BEI DER RÜCKTRANSFORMATION WIRD ÜBER U INTEGRIERT, SOMIT ERFOLGT DIE ZERLEGUNG DER FUNKTION WIEDER IN EXPONENTIALFUNKTIONEN 
% LEDIGLICH DIE ANALYSE DER FUNKTION, ALSO DIE GEWICHTUNG DER EXPONENTIALFUNKTIONEN, DER ZERLEGUNG, ALSO DIE KOEFFIZIENTEN ERFOLGT ÜBER 
% POTENZFUNKTIONEN!!!!!!!!!!!!!
% ist demfall wahrscheinlich bei allen Gelfand-Transformation in etwa der Fall?
% aber: die Basis der Exponentialfunktionen in die f(x) zerlegt wird, ist die Variable x selbst, somit besteht für jeden Punkt x nach f(x)
% aus einer unendlichen Reihe von Schwingungen mit Basis x? Wie ist eine komplexe Exponentialfunktion mit anderer Basis als e überhaupt 
% definiert?
% In der Fourierzerlegung kommt die Variable x im Exponent der komplexen Schwingungen vor, bei Mellin in der Basis Bedeutung?
...
% \begin{definition}
%     Def: Die duale Gruppe einer Integraltransformation ist die Gruppe, auf de
% \end{definition}
