...
\begin{figure}
	\centering
	\subfigure[]{\label{ct:fig:central-slice}\includegraphics[width=0.35\linewidth]{papers/ct/images/central-slice.png}}
	\subfigure[Beispielbild Radon-transformiert.]{\label{ct:fig:central-slice2}\includegraphics[width=0.55\linewidth]{papers/ct/images/central-slice2.png}}
