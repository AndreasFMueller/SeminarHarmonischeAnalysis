...
Durch die Radontransformation entsteht ein Glättungseffekt, welcher in  der Abbildung \ref{ct:fig:bp} gut ersichtlich ist. In dieser Abbildung können gewisse Artefakte in Form von Linien zusätzlich noch gesehen werden.

\begin{figure}
	\centering
	\subfigure[]{\label{ct:fig:central-slice}\includegraphics[width=0.475\linewidth]{papers/ct/images/central-slice.png}}
	\subfigure[]{\label{ct:fig:central-slice2}\includegraphics[width=0.475\linewidth]{papers/ct/images/central-slice2.png}}
