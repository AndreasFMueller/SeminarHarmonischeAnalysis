...
\caption{In dieser Tabelle sind die neun wichtigsten Partialtiden aufgeführt. In der zweiten Spalte, wird die Periode in Stunden angegeben. Ab der vierten Spalte sind die Amplituden der Partialtiden in Zentimeter angegeben. Die Abkürzungen stehen für folgende Orte: MICH=Ostküste im Norden der USA; MS=Westküste der USA; PR=Puerto Rico (Insel zwiscchen Nord- und Südamerika; AK=Kodiak, Alaska; CA=San Francisco, California; HALLO= Hilo, Hawaii)}
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth\linewidth]{"papers/gezeiten/Skizze Integralmaschine"}
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth\linewidth]{papers/gezeiten/Harmonic_analyser_disc_and_sphere}
