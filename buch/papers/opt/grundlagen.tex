...
In dieser Herleitung wird darauf eingegangen, wie aus dem allgemein gültigen Beugungsintegral durch die Fressnel-Approximation das geleichnamige Beugungsintegral und durch die Fraunhofer-Approximation das Fraunhofer-Beugungsinteral hergeleitet werden kann.
...
Soll nun aber anstelle eines einzelnen Spaltes mehere solcher Spalte in beliebigen Abständen betrachtet werden,
kann dieses Integral mit Hilfe der Blendenfunkion
\begin{equation}
f(y)
\in
(0, 1)
\end{equation}
dargestellt werden.
Zu beachten sei, dass $f(y)$ nicht nur die Werte 0 und 1 sondern auch jegliche Werte dazwischen annehemen kann.
...
In nährer Umgebung um die Blende wird hierfür die Fressnel-Approximation angewendet.
...
Desweiteren kann der Ausdruck $l - \frac{(y_p-y)^2}{2l}$ im Nenner des Integrals als $l$ vereinfacht werden.
...
\end{align}
Das hiermit erhaltene Integral wird auch als das Fressnel Beugungsintegral bezeichnet und ist in nährer Umgebung um die Blende gültig.
