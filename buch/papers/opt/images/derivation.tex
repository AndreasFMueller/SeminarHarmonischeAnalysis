...
\begin{tikzpicture}[>=latex,thick,scale=\skala]
    ...
    \draw[->, thin] (0,-1.5)--(0,3) node[above]{$y_b$};

    % Aperture
    \draw[line width=2, black] (0, 1.5)--(0, 2.6);
    \draw[line width=2, black] (0, -0.5)--(0, -1.5);
    ...
    % Charge
    \draw[fill=gray, gray] (0,1.2) circle (1pt) node[black, left]{$dy$};

    % Measurement
    \optMeasurement{0}{6}{-1}{$x_p = l$};
    \draw[<->] (-1,-0.5) -- (-1,1.5) node[anchor=east, midway]{$b$};
    \draw[-,thin, dashed] (-1,1.5)--(0,1.5);
    \draw[-,thin, dashed] (-1,-0.5)--(0,-0.5);
