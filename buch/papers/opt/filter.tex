...
\begin{figure}
    ...
    \subfigure{
        \includegraphics[width=0.23\linewidth, page=1]{papers/opt/images/filterarten.pdf}
        % \caption{Tiefpass}
    }
    \hfill
    \subfigure{
        \includegraphics[width=0.23\linewidth, page=2]{papers/opt/images/filterarten.pdf}
        % \caption{Hochpass}
    }
    \hfill
    \subfigure{
        \includegraphics[width=0.23\linewidth, page=3]{papers/opt/images/filterarten.pdf}
        % \caption{Bandpass}
    }
    \hfill
    \subfigure{
        \includegraphics[width=0.23\linewidth, page=4]{papers/opt/images/filterarten.pdf}
        % \caption{Bandsperre}
    }
