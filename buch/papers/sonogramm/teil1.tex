...
\end{equation}
was zur Folge hat, dass $X(f)$ bei grösser werdenden $f$ mit mit $1/(f^n)$ gegen 
0 gehen muss.

\subsubsection{Gaussfenster}
...
In Abbildung \ref{sonogramm:gausstime} sind zwei Gaussfenster mit unterschiedlichen 
$\alpha$ abgebildet.
...
\subsubsection{Andere Fensterfunktionen}
