...
mehr so einfach wie mit dem linearen Modell aus Gl. \refeq{ml:regression:modell}. 
...
Jedes $l_i$ soll den Output eines Layers darstellen. Zur weiteren Verdeutlichung wird
Gl. \refeq{ml:ann:multilayer-1D} als Gleichungssystem geschrieben:
